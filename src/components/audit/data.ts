...
export const MODULES: Module[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "1.3", title: "Differenzierung", text: "Ich weiß genau, was mein Angebot besonders macht und vom Mitbewerber abhebt." },
      { id: "1.4", title: "Visuelle Abgrenzung", text: "Unser Design (Logo, Farben, Schriften) hebt sich optisch klar von der Konkurrenz ab." },
      ...
      { id: "1.6", title: "Markenversprechen", text: "Ein Außenstehender versteht innerhalb von 3 Sekunden auf unserer Website, was wir tun." },
      { id: "1.7", title: "Preisstrategie", text: "Ich habe eine durchdachte und am Markt durchsetzbare Preisstrategie für mein Angebot." },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "2.3", title: "Kundenprobleme", text: "Ich kenne die tiefen Schmerzpunkte (Pain Points) meiner Kunden in- und auswendig." },
      { id: "2.4", title: "Kaufmotive", text: "Ich weiß genau, was die emotionalen und rationalen Kaufmotive meiner Zielgruppe sind." },
      { id: "2.5", title: "Tonalität & Bildsprache", text: "Unsere visuelle Präsentation (Bilder, Ästhetik) spricht die Gefühlswelt der Wunschkunden an." },
      { id: "2.6", title: "Kundeninterviews", text: "Ich führe regelmäßig Interviews mit potenziellen oder echten Kunden, um sie besser zu verstehen." },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "3.2", title: "Visueller Markenauftritt", text: "Unsere Website und Online- wie Offline-Kanäle wirken absolut professionell und wie aus einem Guss." },
      ...
      { id: "3.4", title: "Google-Unternehmensprofil", text: "Unser Google-Unternehmensprofil ist vollständig eingerichtet und optimiert." },
      { id: "3.5", title: "LinkedIn-Präsenz", text: "Wir nutzen LinkedIn aktiv für unsere geschäftliche Reichweite." },
      { id: "3.6", title: "Instagram-Präsenz", text: "Wir nutzen Instagram aktiv, um für unsere Marke sichtbar zu sein." },
      { id: "3.7", title: "Veranstaltungen", text: "Wir nutzen Messen, Events oder eigene Veranstaltungen für die Sichtbarkeit." },
      { id: "3.8", title: "PR & Pressearbeit", text: "Wir betreiben aktive Pressearbeit, um in den Medien stattzufinden." },
      { id: "3.9", title: "Netzwerkaktivitäten", text: "Wir sind regelmäßig auf Netzwerk-Events aktiv, um Kontakte zu knüpfen." },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "4.2", title: "Content-Ideen", text: "Wir haben einen fortlaufenden Pool an Content-Ideen und uns gehen die Themen nicht aus." },
      ...
      { id: "4.7", title: "KI-Unterstützung", text: "Wir nutzen KI-Tools (wie ChatGPT, Claude, usw.) effizient für unsere Content-Erstellung." },
      { id: "4.8", title: "Rechtssicherheit & Lizenzen", text: "Ich weiß genau, welche Bilder, Schriften und Inhalte ich rechtssicher und mit den passenden Nutzungsrechten verwende." },
