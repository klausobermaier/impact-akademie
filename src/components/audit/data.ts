  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: "5.8",
        title: "Leadqualität",
        text: "Du gewinnst regelmäßig Kontakte, die tatsächlich zu deiner Zielgruppe gehören.",
        isNew: true,
        scaleLabels: [
          "Du weißt nicht, ob deine Leads qualifiziert sind",
          "Du hast erste Einschätzungen zur Qualität deiner Leads",
          "Du kannst die Leadqualität teilweise nachvollziehen",
          "Du überprüfst die Leadqualität regelmäßig",
          "Du misst die Leadqualität systematisch und gewinnst überwiegend hochwertige Kontakte",
        ],
        naLabel: "Nicht relevant",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        text: "Du erfasst und analysierst regelmäßig die wichtigsten Kennzahlen deines Vertriebsprozesses.",
        isNew: true,
        scaleLabels: [
          "Du erfasst keine Vertriebszahlen",
          "Du kennst einzelne Kennzahlen",
          "Du erfasst die wichtigsten Zahlen teilweise",
          "Du erfasst und wertest die Zahlen regelmäßig aus",
          "Du nutzt die Zahlen systematisch zur Steuerung deines Vertriebs",
        ],
        naLabel: "Nicht relevant",
      },
    ],
    ...
    questions: [
      {
        ...
        text: "Wir messen und überprüfen systematisch die Zufriedenheit unserer bestehenden Kunden.",
        scaleLabels: [
          "Wird nicht erfasst",
          "Erste Rückmeldungen werden eingeholt",
          "Gelegentlich überprüft",
          "Regelmäßig überprüft",
          "Systematisch gemessen und zur Verbesserung genutzt",
        ],
        naLabel: "Nicht relevant",
      },
      {
        id: "7.2",
        title: "Wiederkäufer",
        text: "Wir haben Maßnahmen etabliert, die bestehende Kunden zu weiteren Käufen motivieren.",
        scaleLabels: [
          "Keine Maßnahmen vorhanden",
          "Erste Überlegungen vorhanden",
          "Einzelne Kunden kaufen erneut",
          "Wiederkäufe erfolgen regelmäßig",
          "Wiederkäufe sind ein wichtiger Bestandteil des Geschäftsmodells",
        ],
        naLabel: "Nicht relevant",
      },
      {
        id: "7.3",
        title: "Cross-Selling",
        text: "Wir bieten bestehenden Kunden passende ergänzende Produkte oder Dienstleistungen an.",
        scaleLabels: [
          "Nicht vorhanden",
          "Erste Ansätze vorhanden",
          "Gelegentlich genutzt",
          "Wird regelmäßig eingesetzt",
          "Wird regelmäßig eingesetzt und erzielt messbare Ergebnisse",
        ],
        naLabel: "Nicht relevant",
      },
      {
        id: "7.4",
        title: "Upselling",
        text: "Wir bieten höherwertige Angebote an, die für bestehende Kunden attraktiv sind.",
        scaleLabels: [
          "Nicht vorhanden",
          "Erste Ansätze vorhanden",
          "Gelegentlich genutzt",
      ...
      },
      {
        id: "7.5",
        title: "Referenzen",
        text: "Wir bereiten Kundenerfolge aktiv als Case Studies oder Referenzen für unser Marketing auf.",
        scaleLabels: [
          "Nicht vorhanden",
          "Erste Referenzen vorhanden",
          "Einzelne Referenzen werden genutzt",
          "Referenzen werden regelmäßig genutzt",
          "Referenzen sind fester Bestandteil von Marketing und Vertrieb",
        ],
        naLabel: "Nicht relevant",
      },
      {
        id: "7.6",
        title: "Bewertungen",
        text: "Wir haben ein System, um kontinuierlich Sterne-Bewertungen (z. B. Google, Trustpilot) zu sammeln.",
        scaleLabels: [
          "Nicht vorhanden",
          "Einzelne Bewertungen vorhanden",
          "Bewertungen werden gelegentlich gesammelt",
          "Bewertungen werden regelmäßig gesammelt",
          "Es existiert ein systematischer Bewertungsprozess",
        ],
        naLabel: "Nicht relevant",
      },
      {
        ...
        text: "Wir fordern zufriedene Kunden aktiv und systematisch auf, uns weiterzuempfehlen.",
        scaleLabels: [
          "Nicht vorhanden",
          "Empfehlungen entstehen zufällig",
          "Erste Maßnahmen vorhanden",
          "Empfehlungen werden aktiv gefördert",
          "Empfehlungsmarketing ist ein verlässlicher Wachstumskanal",
        ],
        naLabel: "Nicht relevant",
      },
    ],
    ...
    questions: [
      {
        id: "8.1",
        title: "CRM",
        text: "Wir verwalten Kunden- und Interessentendaten systematisch und zentral.",
        scaleLabels: [
          "Nicht vorhanden",
          "Erste Struktur vorhanden",
          "Teilweise genutzt",
          "Im Alltag etabliert",
          "Systematisch genutzt und unterstützt die Kundenarbeit effektiv",
        ],
        naLabel: "Nicht relevant",
      },
      {
        ...
        text: "Unsere Kontakte sind sauber segmentiert und gepflegt, statt in Excel-Listen verstreut zu sein.",
        scaleLabels: [
          "Nicht vorhanden",
          "Erste Struktur vorhanden",
          "Teilweise gepflegt",
          "Sauber gepflegt und regelmäßig genutzt",
          "Systematisch gepflegt und aktiv für Marketing und Vertrieb genutzt",
        ],
        naLabel: "Nicht relevant",
      },
      {
        ...
        text: "Wir nutzen geeignete Werkzeuge für die regelmäßige Kommunikation mit Interessenten und Kunden.",
        scaleLabels: [
          "Nicht vorhanden",
          "Erste Ansätze vorhanden",
          "Teilweise eingerichtet",
          "Im Alltag etabliert",
          "Systematisch genutzt und erzielt messbare Ergebnisse",
        ],
        naLabel: "Nicht relevant",
      },
      {
        ...
        text: "Standardprozesse (z. B. Rechnungsstellung, Terminbestätigung) laufen bei uns vollautomatisch.",
        scaleLabels: [
          "Nicht vorhanden",
          "Erste Automatisierungen vorhanden",
          "Teilweise automatisiert",
          "Mehrere Prozesse automatisiert",
          "Automatisierungen sind fester Bestandteil der Arbeitsabläufe",
        ],
        naLabel: "Nicht relevant",
      },
      {
        id: "8.5",
        title: "KI-Tools",
        text: "Wir nutzen KI-Tools, um wiederkehrende Aufgaben effizienter zu erledigen.",
        scaleLabels: [
          "Nicht genutzt",
          "Erste Versuche durchgeführt",
          "Gelegentliche Nutzung",
          "Regelmäßige Nutzung im Alltag",
          "Systematisch integriert und schafft messbare Effizienzgewinne",
        ],
        naLabel: "Nicht relevant",
      },
      {
        id: "8.6",
        title: "Dokumentation von Prozessen",
        text: "Unsere wichtigsten internen Abläufe sind schriftlich als Standard (SOP) dokumentiert.",
        scaleLabels: [
          "Nicht vorhanden",
          "Erste Dokumentationen vorhanden",
          "Teilweise dokumentiert",
          "Wichtige Prozesse dokumentiert",
          "Prozesse systematisch dokumentiert und gepflegt",
        ],
        naLabel: "Nicht relevant",
      },
      {
        id: "8.7",
        title: "Datenschutzkonforme Plattformen",
        text: "Wir haben geprüft, dass unsere wichtigsten Systeme und Tools datenschutzkonform eingesetzt werden.",
        scaleLabels: [
          "Nicht geprüft",
          "Erste Prüfungen durchgeführt",
          "Teilweise geklärt",
          "Weitgehend geklärt und umgesetzt",
          "Vollständig geprüft, dokumentiert und umgesetzt",
        ],
        naLabel: "Nicht relevant",
      },
      {
        ...
        text: "Du hast klare Regeln für den Umgang mit Kundendaten und Zugriffsrechten.",
        isNew: true,
        scaleLabels: [
          "Du hast keine Regeln für den Umgang mit Daten festgelegt",
          "Du hast erste Regeln für den Datenschutz",
          "Du hast den Umgang mit Daten teilweise geregelt",
          "Du hast klare Regeln festgelegt und kommuniziert",
          "Du regelst den Datenschutz systematisch und überprüfst die Regeln regelmäßig",
        ],
        naLabel: "Nicht relevant",
      },
    ],
    ...
    questions: [
      {
        id: "9.1",
        title: "Ziele",
        text: "Wir haben smarte, messbare Umsatz- und Kundengewinnungsziele schriftlich fixiert.",
        scaleLabels: [
          "Nicht definiert",
          "Erste Ziele formuliert",
          "Teilweise schriftlich festgehalten",
      ...
      },
      {
        id: "9.2",
        title: "Maßnahmen",
        text: "Unsere Marketing- und Vertriebsaktivitäten leiten sich logisch aus unseren Unternehmenszielen ab.",
        scaleLabels: [
          "Nicht definiert",
          "Einzelne Maßnahmen geplant",
          "Teilweise geplant und dokumentiert",
          "Klar geplant und umgesetzt",
          "Systematisch geplant und an den Zielen ausgerichtet",
        ],
        naLabel: "Nicht relevant",
      },
      {
        id: "9.3",
        title: "Prioritäten",
        text: "Ich weiß an jedem Arbeitstag ganz genau, welche Vertriebsaufgabe die höchste Priorität hat.",
        scaleLabels: [
          "Nicht definiert",
          "Erste Prioritäten vorhanden",
          "Teilweise festgelegt",
          "Klar festgelegt und im Alltag genutzt",
          "Konsequent priorisiert und regelmäßig überprüft",
        ],
        naLabel: "Nicht relevant",
      },
      {
        id: "9.4",
        title: "Budget",
        text: "Wir planen und überwachen die Ressourcen, die wir für Marketing und Vertrieb einsetzen.",
        scaleLabels: [
          "Nicht vorhanden",
          "Erste Überlegungen vorhanden",
          "Teilweise geplant",
          "Klar geplant und dokumentiert",
      ...
      },
      {
        id: "9.5",
        title: "Zeitplanung",
        text: "Unsere Kampagnen und Launches sind zeitlich präzise im Voraus geplant.",
        scaleLabels: [
          "Nicht vorhanden",
          "Erste Planungen vorhanden",
          "Teilweise geplant",
          "Klar geplant und dokumentiert",
          "Systematisch geplant und regelmäßig aktualisiert",
        ],
        naLabel: "Nicht relevant",
      },
      {
        id: "9.6",
        title: "90-Tage-Plan",
        text: "Wir steuern das Unternehmen nach einem agilen und fokussierten 90-Tage-Plan.",
        scaleLabels: [
          "Nicht vorhanden",
          "Erste Ansätze vorhanden",
          "Teilweise ausgearbeitet",
          "Klar definiert und genutzt",
          "Regelmäßig genutzt und aktualisiert",
        ],
        naLabel: "Nicht relevant",
      },
      {
        id: "9.7",
        title: "Fokus",
        text: "Du verfolgst konsequent wenige Prioritäten statt viele parallele Marketingmaßnahmen.",
        isNew: true,
        scaleLabels: [
          "Du hast keine klaren Prioritäten gesetzt",
          "Du hast erste Prioritäten definiert",
          "Du arbeitest teilweise fokussiert",
          "Du bist klar fokussiert und setzt deine Prioritäten um",
          "Du behältst konsequent den Fokus und überprüfst deine Prioritäten regelmäßig",
        ],
        naLabel: "Nicht relevant",
      },
    ],
    ...
    questions: [
      {
        ...
        text: "Wir arbeiten mit festen Partnern zusammen, deren Angebot unseres perfekt ergänzt.",
        scaleLabels: [
          "Nicht vorhanden",
          "Erste potenzielle Partner identifiziert",
          "Einzelne Partnerschaften vorhanden",
          "Aktive Partnerschaften bestehen",
          "Partnerschaften liefern regelmäßig Mehrwert oder Geschäftschancen",
        ],
        naLabel: "Nicht relevant",
      },
      {
        ...
        text: "Wir haben Kontakte zu Personen, die Zugang zu unserer gesamten Zielgruppe haben und uns empfehlen.",
        scaleLabels: [
          "Nicht vorhanden",
          "Erste Kontakte vorhanden",
          "Einzelne Multiplikatoren bekannt",
          "Aktive Beziehungen bestehen",
          "Multiplikatoren sorgen regelmäßig für Sichtbarkeit oder Kontakte",
        ],
        naLabel: "Nicht relevant",
      },
      {
        ...
        text: "Wir nutzen relevante Branchen- oder Fachnetzwerke aktiv für unsere Sichtbarkeit und Geschäftsentwicklung.",
        scaleLabels: [
          "Nicht genutzt",
          "Erste Kontakte vorhanden",
          "Mitgliedschaft oder gelegentliche Nutzung",
          "Aktiv genutzt",
          "Aktiv genutzt und liefert regelmäßig Mehrwert oder Kontakte",
        ],
        naLabel: "Nicht relevant",
      },
      {
        id: "10.4",
        title: "Gründernetzwerke",
        text: "Wir sind in Startup-Hubs und Gründernetzwerken aktiv integriert.",
        scaleLabels: [
          "Nicht genutzt",
          "Erste Kontakte vorhanden",
          "Gelegentliche Teilnahme",
          "Aktiv integriert",
          "Aktiv integriert und erzielt regelmäßig Nutzen daraus",
        ],
        naLabel: "Nicht relevant",
      },
      {
        id: "10.5",
        title: "Förderinstitutionen",
        text: "Wir kennen und nutzen relevante Förder- oder Unterstützungsangebote für unser Unternehmen.",
        scaleLabels: [
          "Nicht bekannt",
          "Erste Informationen vorhanden",
          "Erste Kontakte aufgebaut",
          "Aktiver Austausch vorhanden",
          "Förderangebote werden aktiv genutzt oder erschlossen",
        ],
        naLabel: "Nicht relevant",
      },
      {
        id: "10.6",
        title: "Kooperationen",
        text: "Wir führen gemeinsame Aktionen (z. B. Live-Events, Co-Marketing) mit anderen Unternehmen durch.",
        scaleLabels: [
          "Nicht vorhanden",
          "Erste Gespräche geführt",
          "Einzelne Kooperationen vorhanden",
          "Kooperationen werden regelmäßig genutzt",
          "Kooperationen erzeugen regelmäßig Sichtbarkeit, Kontakte oder Umsatz",
        ],
        naLabel: "Nicht relevant",
      },
      {
        id: "10.7",
        title: "Empfehlungsnetzwerke",
        text: "Wir sind Teil von festen Business-Netzwerken, die sich gegenseitig Aufträge zuspielen.",
        scaleLabels: [
          "Nicht vorhanden",
          "Erste Kontakte vorhanden",
          "Einzelne Empfehlungen entstehen",
          "Netzwerk wird regelmäßig genutzt",
          "Netzwerk liefert regelmäßig Empfehlungen oder Aufträge",
        ],
        naLabel: "Nicht relevant",
      },
      {
        id: "10.8",
        title: "Nutzen des Netzwerks",
        text: "Unsere Netzwerke und Partnerschaften führen regelmäßig zu Kontakten, Kunden oder Geschäftsmöglichkeiten.",
        isNew: true,
        scaleLabels: [
          "Kein erkennbarer Nutzen",
          "Erste positive Effekte erkennbar",
          "Gelegentliche Geschäftschancen entstehen",
          "Regelmäßig nützliche Kontakte oder Chancen",
          "Netzwerk ist ein wichtiger Wachstumstreiber des Unternehmens",
        ],
        naLabel: "Nicht relevant",
      },
    ],
