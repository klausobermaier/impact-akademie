  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        text: "Wir haben klare Regeln für den Umgang mit Kundendaten und Zugriffsrechten.",
        isNew: true,
        scaleLabels: [
          "Nicht geregelt",
          "Erste Regeln vorhanden",
          "Teilweise geregelt",
          "Klar geregelt und kommuniziert",
          "Systematisch geregelt und regelmäßig überprüft",
        ],
        naLabel: "Nicht relevant",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: "9.7",
        title: "Fokus",
        text: "Wir verfolgen konsequent wenige Prioritäten statt viele parallele Marketingmaßnahmen.",
        isNew: true,
        scaleLabels: [
          "Nicht vorhanden",
          "Erste Prioritäten vorhanden",
          "Teilweise fokussiert",
          "Klar fokussiert und umgesetzt",
          "Konsequenter Fokus mit regelmäßiger Überprüfung der Prioritäten",
        ],
        naLabel: "Nicht relevant",
      },
    ],
