...
export const MODULES: Module[] = [
  ...
  },
  {
    id: 5,
    key: "M5",
    title: "Interessenten- & Neukunden-Gewinnung",
    isNew: true,
    questions: [
      {
        id: "5.1",
        title: "Erstgespräch",
        text: "Interessenten können unkompliziert mit uns in Kontakt treten oder unser Angebot nutzen.",
        naLabel: "Nicht relevant",
      },
      {
        id: "5.2",
        title: "Bedarfsermittlung",
        text: "Wir verstehen die Bedürfnisse unserer Kunden und können unser Angebot passend präsentieren.",
        naLabel: "Nicht relevant",
      },
      {
        id: "5.3",
        title: "Angebotsprozess",
        text: "Unser Kauf- oder Angebotsprozess ist einfach und nachvollziehbar.",
        naLabel: "Nicht relevant",
      },
      {
        id: "5.4",
        title: "Nachfassen",
        text: "Wir bleiben systematisch mit Interessenten oder Kunden in Kontakt.",
        naLabel: "Nicht relevant",
      },
      {
        id: "5.5",
        title: "Einwandbehandlung",
        text: "Wir kennen typische Kaufhindernisse unserer Kunden und können darauf reagieren.",
        naLabel: "Nicht relevant",
      },
      {
        id: "5.6",
        title: "Abschluss",
        text: "Wir schaffen es regelmäßig, Interessenten in zahlende Kunden zu verwandeln.",
        naLabel: "Nicht relevant",
      },
      {
        id: "5.7",
        title: "Vertriebszahlen",
        text: "Wir kennen die wichtigsten Kennzahlen unseres Kauf- oder Vertriebsprozesses.",
        naLabel: "Nicht relevant",
      },
    ],
  },
