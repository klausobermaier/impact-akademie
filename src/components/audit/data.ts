    ...
    questions: [
      ...
      },
      {
        ...
        scaleLabels: [
          ...
          "Gelegentliche Nutzung",
          "Regelmäßige Nutzung",
          "Systematisch in den Content-Prozess integriert",
        ],
        naLabel: "Nicht relevant",
      },
      {
        ...
        scaleLabels: [
          "Nicht geklärt",
          "Erste Kenntnisse vorhanden",
          "Teilweise geklärt",
          "Weitgehend geklärt",
          "Vollständig geklärt und dokumentiert",
        ],
        naLabel: "Nicht relevant",
      },
      {
        ...
        scaleLabels: [
          ...
          "Teilweise definiert",
          "Klar definiert",
          "Klar definiert und regelmäßig überprüft",
        ],
        naLabel: "Nicht relevant",
      },
    ],
    ...
    questions: [
      {
        id: "5.1",
        title: "Leadquellen",
        text: "Wir wissen genau, über welche Kanäle unsere potenziellen Kontakte (Leads) kommen.",
        scaleLabels: [
          "Nicht bekannt",
          "Erste Vermutungen vorhanden",
      ...
      },
      {
        id: "5.2",
        title: "Leadmagneten",
        text: "Wir haben attraktive 0€-Produkte (Whitepaper, Checklisten etc.), um Kontaktdaten einzusammeln.",
        scaleLabels: [
          "Nicht vorhanden",
          "Erste Ideen vorhanden",
          "Erste Leadmagneten erstellt",
          "Regelmäßig eingesetzt",
          "Regelmäßig eingesetzt und generiert qualifizierte Kontakte",
        ],
        naLabel: "Nicht relevant",
      },
      {
        id: "5.3",
        title: "Landingpages",
        text: "Wir nutzen optimierte Landingpages, die speziell darauf ausgelegt sind, Kontakte zu generieren.",
        scaleLabels: [
          "Nicht vorhanden",
          "Erste Ansätze vorhanden",
          "Landingpages vorhanden",
          "Regelmäßig genutzt",
          "Regelmäßig genutzt und optimiert",
        ],
        naLabel: "Nicht relevant",
      },
      {
        ...
        text: "Unsere Kontakt- oder Leadgewinnungsprozesse sind darauf ausgelegt, Interessenten möglichst einfach zur Kontaktaufnahme zu bewegen.",
        scaleLabels: [
          "Nicht vorhanden",
          "Erste Überlegungen vorhanden",
          "Erste Optimierungen durchgeführt",
          "Regelmäßig überprüft und verbessert",
          "Systematisch optimiert und anhand von Kennzahlen gesteuert",
        ],
        naLabel: "Nicht relevant",
      },
      {
        ...
        text: "Unsere Formulare auf der Website funktionieren technisch einwandfrei und sind einfach auszufüllen.",
        scaleLabels: [
          "Nicht vorhanden",
          "Vorhanden, aber unvollständig",
          "Funktionsfähig eingerichtet",
          "Regelmäßig genutzt",
          "Regelmäßig genutzt und liefert qualifizierte Anfragen",
        ],
        naLabel: "Nicht relevant",
      },
      {
        ...
        text: "Der Anmeldeprozess für unseren Newsletter ist prominent platziert und wird genutzt.",
        scaleLabels: [
          "Nicht vorhanden",
          "Vorhanden, aber wenig sichtbar",
          "Sichtbar integriert",
          "Regelmäßig genutzt",
          "Regelmäßig genutzt und generiert neue Kontakte",
        ],
        naLabel: "Nicht relevant",
      },
      {
        ...
        text: "Wir nutzen eigene Mini-Events oder Webinare gezielt zur Gewinnung neuer Kontakte.",
        scaleLabels: [
          "Nicht genutzt",
          "Erste Überlegungen vorhanden",
          "Einzelne Veranstaltungen durchgeführt",
          "Regelmäßig durchgeführt",
          "Regelmäßig durchgeführt und generiert qualifizierte Kontakte",
        ],
        naLabel: "Nicht relevant",
      },
      {
        id: "5.8",
        title: "Leadqualität",
        text: "Wir gewinnen regelmäßig Kontakte, die tatsächlich zu unserer Zielgruppe gehören.",
        isNew: true,
        scaleLabels: [
          "Nicht bekannt",
          "Erste Einschätzungen vorhanden",
          "Teilweise nachvollziehbar",
          "Regelmäßig überprüft",
          "Systematisch gemessen und überwiegend hochwertige Kontakte",
        ],
        naLabel: "Nicht relevant",
      },
    ],
    ...
    questions: [
      {
        id: "6.1",
        title: "Buchungsweg",
        text: "Interessenten können unkompliziert mit uns Kontakt aufnehmen und ein Erstgespräch vereinbaren.",
        scaleLabels: [
          "Nicht vorhanden",
          "Erste Möglichkeiten vorhanden",
          "Kontaktaufnahme möglich, aber umständlich",
          "Einfach und zuverlässig nutzbar",
          "Einfach nutzbar und wird regelmäßig verwendet",
        ],
        naLabel: "Nicht relevant",
      },
      {
        id: "6.2",
        title: "Erstgespräch",
        text: "Wir haben einen klaren, erprobten Leitfaden für das erste Kennenlerngespräch.",
        scaleLabels: [
          "Kein Leitfaden vorhanden",
          "Erste Struktur vorhanden",
          "Teilweise standardisiert",
          "Klarer Leitfaden wird regelmäßig genutzt",
          "Leitfaden wird regelmäßig genutzt und optimiert",
        ],
        naLabel: "Nicht relevant",
      },
      {
        ...
        text: "Wir können im Gespräch den genauen Bedarf und die Zahlungsbereitschaft des Kunden filtern.",
        scaleLabels: [
          "Nicht vorhanden",
          "Erste Ansätze vorhanden",
          "Teilweise strukturiert",
          "Funktioniert regelmäßig",
          "Funktioniert regelmäßig und führt zu passenden Angeboten",
        ],
        naLabel: "Nicht relevant",
      },
      {
        ...
        text: "Unser Prozess zur Erstellung und Zusendung von Angeboten läuft schnell und standardisiert.",
        scaleLabels: [
          "Nicht vorhanden",
          "Erste Vorlagen oder Abläufe vorhanden",
          "Teilweise standardisiert",
          "Funktioniert regelmäßig",
          "Funktioniert regelmäßig und effizient",
        ],
        naLabel: "Nicht relevant",
      },
      {
        id: "6.5",
        title: "Nachfassen",
        text: "Wir haken bei offenen Angeboten nach einem festen System und Zeitplan nach.",
        scaleLabels: [
          "Erfolgt nicht",
          "Unregelmäßig",
          "Teilweise systematisch",
          "Erfolgt regelmäßig nach einem festen Prozess",
          "Erfolgt regelmäßig und wird anhand der Ergebnisse optimiert",
        ],
        naLabel: "Nicht relevant",
      },
      {
        ...
        text: "Wir können mit typischen Kundeneinwänden (z. B. „Zu teuer\", „Keine Zeit\") souverän umgehen.",
        scaleLabels: [
          "Nicht vorbereitet",
          "Erste Erfahrungen vorhanden",
          "Teilweise vorbereitet",
          "Funktioniert regelmäßig",
          "Funktioniert regelmäßig und erhöht nachweislich die Abschlussquote",
        ],
        naLabel: "Nicht relevant",
      },
      {
        id: "6.7",
        title: "Abschluss",
        text: "Wir führen Verkaufsgespräche strukturiert und zielgerichtet bis zu einer Entscheidung.",
        scaleLabels: [
          "Kein strukturierter Abschlussprozess vorhanden",
          "Erste Ansätze vorhanden",
          "Teilweise strukturiert",
          "Funktioniert regelmäßig",
          "Funktioniert regelmäßig und führt zu planbaren Abschlüssen",
        ],
        naLabel: "Nicht relevant",
      },
      {
        id: "6.8",
        title: "Vertriebszahlen",
        text: "Wir erfassen und analysieren regelmäßig die wichtigsten Kennzahlen unseres Vertriebsprozesses.",
        isNew: true,
        scaleLabels: [
          "Werden nicht erfasst",
          "Einzelne Kennzahlen bekannt",
          "Teilweise erfasst",
          "Regelmäßig erfasst und ausgewertet",
          "Systematisch genutzt zur Steuerung des Vertriebs",
        ],
        naLabel: "Nicht relevant",
      },
    ],
